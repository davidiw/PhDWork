...
\item CONNECTIVITY. Network asymmetries created by firewalls, NAT (network
address translation), and Internet router outages motivate the use for VPNs.
One approach is to route all traffic through a third party, but this incurs
overheads.  There also exist approaches to allow two peers behind NAT devices
