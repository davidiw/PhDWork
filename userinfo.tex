...
\SetThesisType{Proposal}%Tutorial}%{dissertation} %{thesis}
\SetDegreeType{Doctor of Philosophy}% {Master of Science}
\SetGradMonth{February}
\SetGradYear{2009}
...
\SetTitle{ON THE DESIGN and IMPLEMENTATION OF \newline USER-FRIENDLY, SELF-CONFIGURING, AND SCALABLE \newline VIRTUAL PRIVATE NETWORKS}
